...
<div class="col-md-12 col-lg-12">
	...
	<div class="col-md-7 dummyfull">
					...
					<b>Not yet registered</b>
						<div class="checkbox">
							...
							<ul class="register_note">
								<li>-	Einmalige Registrierung fÃ¼r alle angeschlossen Anbieter</li>
								<li>-	Ãbersciht aller vergangen und zukÃ¼nftigen Reservierungen </li>
								<li>-	Storno via one click</li>
								<li>-	Sie entscheiden welcher Anieter Ihre E-mail Addresse Sehen kann</li>
								<li>-	Hinweis bei BuchungÃ¼berlappungen</li>
							</ul>
					</div>
			</div>
		...
		<!-- ------------------------------------   END   ---------------------------------------------->
			...
			<hr/>
			<p style="padding:0px 80px 15px 80px;font-size:13px;">Durch klicken auf â Registrieung abschlieÃenâ stimmen sie den Nutzungbedinungen und der DatenschutzerklÃ¤rung von world of Reservation zu</p>
			</div>
			<div id="fade" class="black_overlay"></div>
...
<!-- ================================  MANUAL RESERVATION FOR SERVICE PROVIDER MODAL ==========================================-->
			...
			<div id="fade" class="black_overlay"></div>
<!-- ================================  PERMANENT RESERVATION FOR SERVICE PROVIDER MODAL ==========================================-->
			<div id="myp_reservation" class="white_content">
			<h3>Permanent Reservation</h3>
			<a href ="javascript:void(0)" class="close_popup" onclick = "document.getElementById('myp_reservation').style.display='none';document.getElementById('fade').style.display='none'"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a>
			<div style="padding:0px">
				<form class="form-horizontal">
					<div class="reservation-data-section">
					<div class="col-xs-1">
	...
	<div class="col-xs-3 hotel_title nopadding">
				...
				<div class="iconset">
						...
						<div class="btn-group">
						  <button type="button" class="btn btn-default dropdown-toggle btn-blank" data-toggle="dropdown" aria-expanded="false">
							<img src="images/bluepat.png" />
						  </button>
						  <ul class="dropdown-menu" role="menu">
							<li><a href="initChangeRoom.htm"><img src="images/brownpat.png" style="padding-right:6px;" /></a></li>
							<li><a href="javascript:void(0)"><img src="images/bluepat.png" style="padding-right:6px;" /></a></li>
			...
			<div class="col-xs-12" style="display:none;">
						<div class="iconset100">
							...
							<a href = "#" ><img src="images/arrows.png" /></a>
							<a href = "whitelist.html"><img src="images/whitelist.png" /></a>
							<a href = "blacklist.html"><img src="images/blacklist.png" /></a>
							<a href = "blacklist.html"><img src="images/mails.png" /></a>
							<a href = "blacklist.html"><img src="images/add_wlu.png" /></a>
						</div>
			</div>
			<div class="clearfix"></div>
				<div class="col-xs-3 nopadding"><button class="btn btn-default btn-current-date">06-06-2015</button></div>
				<div class="col-xs-3 ">
							 ...
							 <!-- Wrapper for slides -->
							   <div class="carousel-caption1">
										<div class="piece">
												...
												<span class="month_title">Sept</span>
												...
												<span class="cal_date permanent_blue" date-value="23-07-2015">23</span>
												<span class="cal_date permanent_blue" date-value="24-07-2015">24</span>
												<span class="cal_date permanent_blue" date-value="25-07-2015">25</span>
												<span class="cal_date permanent_blue" date-value="26-07-2015">26</span>
												<span class="cal_date" date-value="27-07-2015">27</span>
												<span class="cal_date" date-value="28-07-2015">28</span>
												<span class="cal_date permanent_blue" date-value="29-07-2015">29</span>
												<span class="cal_date permanent_blue" date-value="30-07-2015">30</span>
												<span class="month_title">Oct</span>
												<span class="cal_date">01</span>
												<span class="cal_date">02</span>
												<span class="cal_date">03</span>
												<span class="cal_date permanent_blue">04</span>
												<span class="cal_date permanent_blue">05</span>
												<span class="cal_date">06</span>
												<span class="cal_date permanent_blue">07</span>
												<span class="cal_date permanent_blue">08</span>
												<span class="cal_date permanent_blue">09</span>
												<span class="cal_date permanent_blue">09</span>
												<span class="cal_date permanent_blue">10</span>
												<span class="cal_date">11</span>
												<span class="cal_date">12</span>
												<span class="cal_date">13</span>
												<span class="cal_date permanent_blue">14</span>
												<span class="month_title">Oct</span>
												<span class="cal_date permanent_blue">15</span>
												<span class="cal_date">16</span>
												<span class="cal_date permanent_blue">17</span>
												<span class="cal_date permanent_blue">18</span>
												<span class="cal_date permanent_blue">19</span>
												<span class="cal_date permanent_blue">20</span>
												<span class="cal_date permanent_blue">21</span>
												<span class="cal_date">11</span>
												<span class="cal_date">12</span>
												<span class="cal_date">13</span>
												<span class="cal_date permanent_blue">14</span>
												...
												<span class="cal_date permanent_blue">25</span>
												<span class="cal_date permanent_blue">26</span>
												<span class="cal_date">27</span>
												<span class="cal_date permanent_blue">28</span>
												<span class="cal_date permanent_blue">29</span>
												<span class="cal_date permanent_blue">30</span>
												<span class="cal_date permanent_blue">01</span>
												<span class="cal_date permanent_blue">02</span>
												</div>
										</div>
								</div>
							</div>
									...
									<div class="item active">
									  <div class="carousel-caption">
											<div class="col-xs-3 col-xs-3-fixed nopadding book_info">
												<div class="cell cell_header">Monday</div>
												<div class="cell_room_admin_permanent reserved">
													<a href="javascript:void(0)" class="room_info" onclick="document.getElementById('myp_reservation').style.display='block';document.getElementById('fade').style.display='block'">
													Room 1<br/>
													[Single]<br/>
													3
											...
											<div class="col-xs-3 col-xs-3-fixed nopadding book_info">
											<div class="cell cell_header">Tuesday</div>
												<div class="cell_room_admin_permanent reserved">
													<a href="javascript:void(0)" class="room_info" onclick="document.getElementById('myp_reservation').style.display='block';document.getElementById('fade').style.display='block'">
													Room 2<br/>
													[Single]<br/>
											...
											<div class="col-xs-3 col-xs-3-fixed nopadding book_info">
											<div class="cell cell_header">Wednesday</div>
												<div class="cell_room_admin_permanent reserved">
													<a href="javascript:void(0)" class="room_info" onclick="document.getElementById('myp_reservation').style.display='block';document.getElementById('fade').style.display='block'">
													Room 5<br/>
													[Single]<br/>
											...
											<div class="col-xs-3 col-xs-3-fixed nopadding book_info">
											<div class="cell cell_header">Thursday</div>
												<div class="cell_room_admin_permanent permanent_booked">
													<a href="javascript:void(0)" class="room_info" onclick="document.getElementById('myp_reservation').style.display='block';document.getElementById('fade').style.display='block'">
													Room 3<br/>
													[Single]<br/>
													3
											...
											<div class="col-xs-3 col-xs-3-fixed nopadding book_info">
											<div class="cell cell_header">Friday</div>
												<div class="cell_room_admin_permanent reserved">
													<a href="javascript:void(0)" class="room_info" onclick="document.getElementById('myp_reservation').style.display='block';document.getElementById('fade').style.display='block'">
													Room 3<br/>
													[Single]<br/>
											...
											<div class="col-xs-3 col-xs-3-fixed nopadding book_info">
											<div class="cell cell_header">Saturday</div>
												<div class="cell_room_admin_permanent permanent_booked">
													<a href="javascript:void(0)" class="room_info" onclick="document.getElementById('myp_reservation').style.display='block';document.getElementById('fade').style.display='block'">
													Room 12<br/>
													[Single]<br/>
											...
											<div class="col-xs-3 col-xs-3-fixed nopadding book_info">
											<div class="cell cell_header">Sunday</div>
												<div class="cell_room_admin_permanent permanent_booked">
													<a href="javascript:void(0)" class="room_info" onclick="document.getElementById('myp_reservation').style.display='block';document.getElementById('fade').style.display='block'">
													Room 12<br/>
													[Single]<br/>
