...
public class EventsOrganizerDTO {
	...
	public String toString() {
		return "EventsOrganizerDTO [eventOrgId=" + eventOrgId
				+ ", eventOrgName=" + eventOrgName + ", eventOrgAddress="
				+ eventOrgAddress + ", eventOrgCity=" + eventOrgCity
				+ ", eventOrgPostalCode=" + eventOrgPostalCode
				+ ", eventOrgEmail=" + eventOrgEmail + ", eventOrgWebiste="
				+ eventOrgWebiste + ", eventOrgPhoneNumber="
				+ eventOrgPhoneNumber + ", strtDate=" + strtDate + "]";
	}
