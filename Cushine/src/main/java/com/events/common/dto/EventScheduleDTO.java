...
public class EventScheduleDTO {
	...
	private List<EventListDTO> eventLists;
	...
	public List<EventListDTO> getEventLists() {
		return eventLists;
	}

	public void setEventLists(List<EventListDTO> eventLists) {
	...
	public List<EventScheduleDTO> getEventScheduleDTOs() {
		return eventScheduleDTOs;
	}

	public void setEventScheduleDTOs(List<EventScheduleDTO> eventScheduleDTOs) {
		this.eventScheduleDTOs = eventScheduleDTOs;
	}
	...
	public String toString() {
		return "EventScheduleDTO [scheduleId=" + scheduleId + ", eventId="
				+ eventId + ", date=" + date + ", startTime=" + startTime
				...
				+ ", divCount=" + divCount + ", eventName=" + eventName
				+ ", guideName=" + guideName + ", guideId=" + guideId
				+ ", eventOrgId=" + eventOrgId + ", userNotes=" + userNotes
				+ ", isPaid=" + isPaid + ", isArrived=" + isArrived
				+ ", eventScheduleDTOs=" + eventScheduleDTOs + ", eventLists="
				+ eventLists + ", haveReservation=" + haveReservation
